...
$insertUser = $conn->prepare('INSERT INTO users (username, password, usergroup, email, nickname, usercreated, userlastlogin) VALUES (:username,:password,:usergroup,:email,:nickname,:usercreated,:userlastlogin)');
