...
try {
    $insertUser = $conn->prepare('INSERT INTO user (username, password, usergroup, email, nickname, usercreated, userlastlogin) VALUES (:username,:password,255,:email,:nickname,:usercreated,:userlastlogin)');
